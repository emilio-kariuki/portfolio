...
function MeCard() {
  ...
  return (
    <div
      className={`flex flex-col items-center  rounded-[20px]  border-[#363535] bg-[#F5F6F8]   px-4 py-6 lg:px-16 lg:py-16 md:px-16 md:py-16 2xl:px-16 2xl:py-16 dark:border-[0.1px] dark:bg-[#030b20] mx-h-[1000px] `}
    >
      <h1
